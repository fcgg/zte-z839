	...
	struct msm_camera_i2c_client *sensor_i2c_client)
{
	...
	for (index = 0; index < ctrl->power_setting_size; index++) {
		...
		case SENSOR_GPIO:
			...
			//pr_err("power_setting->seq_val=%d ctrl->gpio_conf->gpio_num_info->valid[power_setting->seq_val]=%d\n",power_setting->seq_val,ctrl->gpio_conf->gpio_num_info->valid[power_setting->seq_val]);
