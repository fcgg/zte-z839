...
#endif
#if defined(CONFIG_SENSORS_TSL2771)
extern int syna_touch_module_for_lsensor_taos;
#endif
//
	...
	int *p_fw_ver )
{
	...
	case '2':
		...
		sprintf(p_sensor, "Eachopto_truly(0x%x)",ts->config_id.sensor);
    ...
    #endif
    #if defined(CONFIG_SENSORS_TSL2771)
    syna_touch_module_for_lsensor_taos = touch_moudle;
	pr_info("%s: set syna_touch_module_for_lsensor_taos=%d\n", __func__, syna_touch_module_for_lsensor_taos);
    #endif
