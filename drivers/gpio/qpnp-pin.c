...
#include <linux/seq_file.h>			//zte PM add 
...
int pmic_dump_pins(struct seq_file *m, int curr_len, char *gpio_buffer) //ZTE_PM
{
	char read_buf[256];
...
subsys_initcall(qpnp_pin_init); //add by zte jiangzhineng
