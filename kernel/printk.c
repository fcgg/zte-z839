...
#else
static char tmpbuf[1024]; //zte_pm_lhx_20160317 merge yangxinli code to fix kernel panic
...
#if 0 //zte_pm_lhx_20160317 merge yangxinli code to fix kernel panic
	if (!buf)
		return snprintf(NULL, 0, "[%5lu.000000] ", (unsigned long)ts);
#endif
        ...
        if (!buf) {
              ...
              buf=tmpbuf;
       }//zte_pm_lhx_20160317 merge yangxinli code to fix kernel panic
